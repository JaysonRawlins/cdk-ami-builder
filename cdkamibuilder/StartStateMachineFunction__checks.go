...
func (s *jsiiProxy_StartStateMachineFunction) validateGrantInvokeParameters(identity awsiam.IGrantable) error {
	if identity == nil {
...
func (s *jsiiProxy_StartStateMachineFunction) validateGrantInvokeUrlParameters(identity awsiam.IGrantable) error {
	if identity == nil {
		return fmt.Errorf("parameter identity is required, but nil was provided")
	}
