...
func (c *jsiiProxy_CheckStateMachineStatusFunction) GrantInvoke(identity awsiam.IGrantable) awsiam.Grant {
	if err := c.validateGrantInvokeParameters(identity); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CheckStateMachineStatusFunction) GrantInvokeUrl(identity awsiam.IGrantable) awsiam.Grant {
	if err := c.validateGrantInvokeUrlParameters(identity); err != nil {
		panic(err)
	}
	var returns awsiam.Grant
