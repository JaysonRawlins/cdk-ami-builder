...
func (s *jsiiProxy_StartStateMachineFunction) GrantInvoke(identity awsiam.IGrantable) awsiam.Grant {
...
func (s *jsiiProxy_StartStateMachineFunction) GrantInvokeUrl(identity awsiam.IGrantable) awsiam.Grant {
